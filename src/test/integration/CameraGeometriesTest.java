...
public class CameraGeometriesTest {
	...
	public void testSphere() {
		...
		sphere = new Sphere(null, new Point(0, 0, -2), 2);
		...
		sphere = new Sphere(null, Point.ORIGIN, 4);
	...
	public void testTriangle() {
		...
		Triangle triangle = new Triangle(null, new Point(0, 5, 2), new Point(-3, 5, -1), new Point(3, 5, -1));
		...
		triangle = new Triangle(null, new Point(0, 5, 10), new Point(-30, 5, -10), new Point(30, 5, -10));
		...
		triangle = new Triangle(null, new Point(0, 5, 10), new Point(-5, 5, -10), new Point(5, 5, -10));
		...
		triangle = new Triangle(null, new Point(0, 5, 0), new Point(-5, 2, 0), new Point(5, 2, 0));
